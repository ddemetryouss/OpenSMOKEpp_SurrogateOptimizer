...
% --------------------------- BEGIN CODE -------------------------------- %
    ...
    if (optimizer.error_type == 1)
        ...
        optimizer.F_rho = (1. - exp( -(rho_surrogate-target.rho)^2/(2*target.sigma_rho^2)))^2;
    ...
    elseif (optimizer.error_type == 2)
        ...
        optimizer.F_rho = (1. - rho_surrogate/target.rho)^2;
    ...
    elseif (optimizer.error_type == 3)
        ...
        optimizer.F_rho = (1. - exp( -(rho_surrogate-target.rho)^2/target.rho))^2;
    ...
    f = optimizer.weight_HC*optimizer.F_HC + ...
        ...
        optimizer.weight_rho*optimizer.F_rho;
